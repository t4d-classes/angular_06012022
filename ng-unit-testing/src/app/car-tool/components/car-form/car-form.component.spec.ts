...
import {
  getNativeElement, setFormControl, getFormControl,
...
describe('CarFormComponent', () => {
  ...
  it('should fail validation when submit button clicked', () => {
    ...
    expect(getFormControl(fixture, 'make-input'))
      .toEqual(inputCar.make);
    expect(getFormControl(fixture, 'model-input'))
      .toEqual(inputCar.model);
    expect(getFormControl(fixture, 'year-input'))
      .toEqual(String(inputCar.year));
    expect(getFormControl(fixture, 'color-input'))
      .toEqual(inputCar.color);
    expect(getFormControl(fixture, 'price-input'))
      .toEqual('-1');
